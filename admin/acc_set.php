                    ...
                    <div id="main">
                        ...
                        <section id="content_wrapper">
                            ...
                            <div id="content">
                                <div class="row">
                                    <?php
                                    $tp_acc=mysqli_fetch_row(mysqli_query($conn,"Select nama_lengkap, username, password from tb_admin where id_admin='$fi_id'"));
                                    if(isset($_POST['tb_biaya']))
                                    {
                                        ...
                                        if(empty($username))
                                        {
                                            mysqli_query($conn,"Update tb_admin set nama_lengkap='$na', username='$tp_acc[1]', password='$ps' where id_admin='$fi_id'");
                                            ?>
                                        ...
                                        {
                                            $cek_user=mysqli_num_rows(mysqli_query($conn,"Select * from tb_admin where username='$username' and id_admin!='$fi_id'"));
                                            if($cek_user>0)
                                            {
                                                ?>
                                            ...
                                            {
                                                mysqli_query($conn,"Update tb_admin set nama_lengkap='$na', username='$username', password='$ps' where id_admin='$fi_id'");
                                                ?>
                                                <div class="alert alert-success alert-dismissable">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <i class="fa fa-check pr10"></i>
