        ...
        if($status=="Wawancara")
            {
                ...
                <head>
                   ...
                   <meta charset="utf-8">
                    <title>Log Aktifitas User</title>
                    <meta name="keywords" content="Log Aktifitas User" />
                    <meta name="description" content="Log Aktifitas User">
                    <meta name="author" content="Log Aktifitas User">
                                ...
                                <div class="topbar-left">
                                    <ol class="breadcrumb">
                                        <li class="crumb-active">
                                            <a href="lkp_form">Log Aktifitas User</a>
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div class="row">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <span class="panel-title">Proses Log Aktifitas User</span>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            {
                                                $d=$_GET['d'];
                                                mysqli_query($conn,"Delete from tb_siswa where id_siswa='$d'");
                                                mysqli_query($conn,"Delete from tb_konfirmasi_pendaftaran where id_siswa='$d'");
                                                mysqli_query($conn,"Delete from tb_pembayaran where id_pembayaran='$d'");
                                                ?>
                                                <div class="alert alert-success alert-dismissable">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <i class="fa fa-check pr10"></i>
                                                <strong>Selamat</strong> Anda Berhasil Menghapus Salah Satu User
                                                <a href="#" class="alert-link"> Silahkan Hapus User Yang Lain Bila Diperlukan</a>.</div>
                                                <meta http-equiv="refresh" content="5;url=lg_user">
                                                <?php
                                            }
